...
{
    /// <summary>
    /// ReprotPrinter: Print report without PrintDialog
    /// </summary>
    class ReportPrinter : IDisposable
    {
        ...
        public ReportPrinter(DataTable dataTable, string dataSetName,string reportName) {
